							...
							<div class="col-md-12">
						        ...
						        <div class="tab-content">
						            <div class="tab-pane active" id="tabNotGen">
				                        <form id="form_notificaciones_generales" action="{{url('admin/notificaciones_app/enviar/general')}}" onsubmit="return false" method="POST" autocomplete="off">
									        	...
									        	<div class="col-sm-12 col-xs-12">
						                            <div class="form-group">
														...
														<select name="aplicacion" id="aplicacion_general" name="aplicacion" class="form-control" style="width: 100%">
															...
															<option value="1">Sendenshop</option>
															<option value="2">Sendenboy</option>
														</select>
													</div>
												</div>
						            ...
						            <div class="tab-pane" id="tabNotInd">
				                        <form id="form_notificaciones_individuales" action="{{url('admin/notificaciones_app/enviar/individual')}}" onsubmit="return false" method="POST" autocomplete="off">
										    <input type="hidden" name="_token" id="token" value="{!! csrf_token() !!}">
			                    			<div class="row">
			                    				<div class="col-sm-12 col-xs-12">
						                            <div class="form-group">
		...
		$( "select#aplicacion_individual" ).change(function() {
		    ...
		    if (options) {
		    	...
		    	options.forEach( function (opt) {
		    		select.append("<option value="+ opt.id +">"+ opt.name + ' '+ opt.surname +"</option>");
				});
		    }
		});
	});
